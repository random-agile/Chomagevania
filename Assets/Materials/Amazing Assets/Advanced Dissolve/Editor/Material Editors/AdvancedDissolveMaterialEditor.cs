...
namespace AmazingAssets.AdvancedDissolveEditor
{
    ...
    static public class MaterialEditor
    {
        ...
        static public void DrawCurvedWorldHeader(UnityEditor.MaterialEditor materialEditor)
        {
            if (_CurvedWorldBendSettings != null)
            {
                EditorGUI.BeginChangeCheck();
                foldoutCurvedWorld = EditorGUILayout.BeginFoldoutHeaderGroup(foldoutCurvedWorld, "Curved World");
                if(EditorGUI.EndChangeCheck())
                {
                    EditorPrefs.SetBool(prefName_CurvedWorldFoldout, foldoutCurvedWorld);
                }

                if (foldoutCurvedWorld)
                {
